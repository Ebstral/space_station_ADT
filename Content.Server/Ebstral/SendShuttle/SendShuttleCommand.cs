using System.Linq;
using Content.Server.Ebstral.ERT.SendShuttleSystem;
...
namespace Content.Server.Ebstral.ERT.SendShuttleCommand;
...
public sealed class SendShuttleCommand : IConsoleCommand
{
    ...
    public void Execute(IConsoleShell shell, string argStr, string[] args)
    {
        ...
        _entitySystemManager.GetEntitySystem<SendShuttle>().SpawnShuttle(args[0], playAnnounce);

        _adminLogger.Add(LogType.Action, LogImpact.High,
            $"{player} send shuttle. Type: {args[0]}");
    }
    ...
    public CompletionResult GetCompletion(IConsoleShell shell, string[] args)
    {
        if (args.Length == 1)
        {
            ...
            return CompletionResult.FromHintOptions(options,
                Loc.GetString("send-shuttle-hint-type"));
        }
        ...
        if (args.Length == 2)
        {
            ...
            return CompletionResult.FromHintOptions(options,
                Loc.GetString("send-shuttle-hint-isannounce"));
        }
